...
public class ChangePasswordController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (u == null) {
            ...
            SceneNavigator.setRoot(btnChange.getScene(), "/se2203b/assignments/views/Login.fxml", "iSky - Authentication", 400.0, 500.0);
            return;
        }
    ...
    private void handleChangePassword() {
        ...
        busy.set(true);
        try {
            // OWASP: verify current password in change-password feature
            userAccountService.changePassword(u.getUsername(), current, nw);

            // “Session renewal” concept: simplest is force re-login after password change
            // (common recommendation in secure session management discussions).
            AppSession.clear();
            SceneNavigator.setRoot(btnChange.getScene(), "/se2203b/assignments/views/Login.fxml", "iSky - Change password form", 500.0, 550.0);
