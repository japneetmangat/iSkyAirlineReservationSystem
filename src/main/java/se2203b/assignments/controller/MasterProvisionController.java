...
import se2203b.assignments.service.PasswordUtil;
...
public class MasterProvisionController  implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (current == null || current.getRole() != Role.MASTER) {
            ...
            if (btnContinue != null && btnContinue.getScene() != null) {
                SceneNavigator.setRoot(btnContinue.getScene(), "/se2203b/assignments/views/Login.fxml","iSky Authentication", 400.0, 500.0); // scene swap
    ...
    private void createRoleAccount(Role role, TextField txtUser, PasswordField pwd, Label lblStatusRole, Button btnCreateRole) {
        ...
        try {
            ...
            UserAccount u = new UserAccount(username, role, hash, true);
    ...
    private void handleContinue() {
        SceneNavigator.setRoot(btnContinue.getScene(), "/se2203b/assignments/views/Main.fxml", "iSky - User Role Creations", 1000.0, 740.0);
    }
}